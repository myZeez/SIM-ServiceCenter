<div class="space-y-6">
    ...
    <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm p-4 border border-gray-200 dark:border-gray-700">
        <div class="flex flex-wrap items-center gap-4">
            ...
            <div class="ml-auto text-sm text-gray-500 dark:text-gray-400">
                <span class="font-semibold text-red-600">Mode: READ ONLY</span> - Super Admin Monitoring
            </div>
        </div>
    </div>
    ...
    {{-- 4. MONITORING SERVIS REGULER (READ ONLY) --}}
    <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 overflow-hidden">
        <div class="px-6 py-4 border-b border-gray-200 dark:border-gray-700 bg-blue-50 dark:bg-blue-900/20">
            <h3 class="text-lg font-bold text-gray-900 dark:text-white flex items-center gap-2">
                ...
                <span class="ml-2 px-2 py-0.5 bg-blue-100 text-blue-700 text-xs rounded-full">READ ONLY</span>
            </h3>
        </div>
    ...
    {{-- 5. MONITORING SERVIS GARANSI (READ ONLY) --}}
    <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 overflow-hidden">
        <div class="px-6 py-4 border-b border-gray-200 dark:border-gray-700 bg-purple-50 dark:bg-purple-900/20">
            <h3 class="text-lg font-bold text-gray-900 dark:text-white flex items-center gap-2">
                ...
                <span class="ml-2 px-2 py-0.5 bg-purple-100 text-purple-700 text-xs rounded-full">READ ONLY</span>
            </h3>
        </div>
        <div class="overflow-x-auto max-h-96">
            <table class="w-full text-sm">
