        ...
        <div class="flex h-screen overflow-hidden">
            ...
            >
                ...
                <nav class="flex-1 overflow-y-auto overflow-x-hidden py-3 px-2 space-y-0.5 scrollbar-thin">
                    ...
                    <a href="{{ route('expert-system.devices') }}"
                        class="flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium transition-all duration-150 group relative
                            {{ request()->routeIs('expert-system.devices') || request()->routeIs('expert-system.diseases') || request()->routeIs('expert-system.symptoms')
                                ? 'bg-primary-50 dark:bg-primary-900/30 text-primary-700 dark:text-primary-400'
                                : 'text-gray-600 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-800 hover:text-gray-900 dark:hover:text-white' }}">
                        <svg class="w-5 h-5 flex-shrink-0 {{ request()->routeIs('expert-system.devices') || request()->routeIs('expert-system.diseases') || request()->routeIs('expert-system.symptoms') ? 'text-primary-600 dark:text-primary-400' : 'text-gray-400 group-hover:text-gray-600 dark:group-hover:text-gray-300' }}" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <a href="{{ route('expert-system.services') }}"
                        ...
                        <span x-show="!sidebarCollapsed" x-transition:enter="transition-opacity duration-200" x-transition:enter-start="opacity-0" x-transition:enter-end="opacity-100" class="whitespace-nowrap">Informasi Layanan</span>
                        <span x-show="sidebarCollapsed" class="absolute left-full ml-3 px-2 py-1 bg-gray-900 text-white text-xs rounded-lg opacity-0 group-hover:opacity-100 pointer-events-none transition-opacity duration-150 whitespace-nowrap z-50 shadow-lg">Informasi Layanan</span>
                    </a>
                    @endif                </nav>
            ...
            >
                ...
                <nav class="flex-1 overflow-y-auto py-3 px-2 space-y-0.5">
                    ...
                    <a href="{{ route('expert-system.devices') }}" @click="mobileOpen = false" class="flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium {{ request()->routeIs('expert-system.devices') || request()->routeIs('expert-system.diseases') || request()->routeIs('expert-system.symptoms') ? 'bg-primary-50 dark:bg-primary-900/30 text-primary-700 dark:text-primary-400' : 'text-gray-600 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-800' }}">
